...
d_c1s_Ek = CSV.File(string("/home/matthew/Data/XPS/","C1s on Ek, Na-prop and Prop.csv"); delim=",", header=true) |> DataFrame
...
##
d_Na = CSV.File(string("/home/matthew/Data/XPS/","na_prop_prop_2_output(1).csv"); delim=",", header=true) |> DataFrame
