...
TICKS_FONTSIZE  = 16
ANOTA_FONTSIZE  = 16
fig0 = figure(1,figsize=[10,7]);

for i_noise in 1:2:3
    ...
    σd           = 0.1
    cor_len_lowres = 2.5
    save_folder  = string("results/",profile_flag,"/",mod_str,"/",mod_err,"/",dat_noise,prior_strength,"/")
    ...
    data_folder  = string(model_folder,profile_flag,"/",dat_noise)
    ...
    if i_noise==1
        ...
        ax1         = subplot(223) # variability of the estimates
    end
    # if FLAG_0002
    #     ax1         = subplot(321)
    # elseif FLAG_0003
    ...
    legend(l_variability,l_names,fontsize=LEGEND_FONTSIZE,loc="upper left",borderpad=0.4,borderaxespad=0.2,handletextpad=0.5,handlelength=1.0,framealpha=0.4)
    ...
    if i_noise==1
        ...
        ax2         = subplot(224) # variability of the estimates
    end
    # if FLAG_0002
    #     ax2         = subplot(322)
    # elseif FLAG_0003
    ...
    legend(l_post,l_names,fontsize=LEGEND_FONTSIZE,loc="upper left",borderpad=0.4,borderaxespad=0.2,handletextpad=0.5,handlelength=1.0,framealpha=0.4)
...
tight_layout(pad=1.0, w_pad=0.5, h_pad=0.0)
