...
for idx_file in 1:length(data_filesO1s)
    ...
    dictAllData,df_fit,Ndata = dataAndFit_xlsx2df(string(data_folderO1s,fileName,".xlsx"); regData=regData, regFit=regFit, regEph=regEph, sortBy=sortBy, thenSortBy=thenSortBy);
